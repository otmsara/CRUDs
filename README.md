...
- **Read** — Fetch one or all records
- **Update** — Modify an existing record
- **Delete** — Remove a record

## Contributing

Contributions are welcome! To add a new implementation:

1. Fork the repo
2. Create a folder: `language-framework/`
3. Include a `README.md` with setup steps
